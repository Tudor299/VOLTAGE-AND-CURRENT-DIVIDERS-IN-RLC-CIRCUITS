...
% Last Modified by GUIDE v2.5 29-Dec-2019 11:39:20
...
R = str2num(get(handles.edit1,'String'))*1000;
R1 = str2num(get(handles.edit2,'String'))*1000;
C = str2num(get(handles.edit3,'String'))*(1/1000000);
...
vI = A*a;
s=complex(0,w);
z1 = R1/(1+R1^2*C^2*w^2);
z2 = -(R1^2*C*w)/(1+R1^2*C^2*w^2);
Z = complex(z1,z2);
vo = (Z/(R+Z))*vI;
vO = vo/a;
I = vO/(R+Z)*1000;
